...
2. Run the installer. It places:
   ...
   - Standalone → `/Applications/Robin Control Lite.app`
...
2. Run the installer. It places:
   ...
   - Standalone → `C:\Program Files\conduit.dsp\Robin Control Lite\`
3. Rescan plugins in your DAW.
...
Built artifacts land in `NewProject/build/RobinControlLite_artefacts/Release/{VST3,AU,Standalone}/` and are auto-copied to the system plugin folders for testing. See [`spec.md`](spec.md) §3 for the full build details and §5 for signing/notarization.
